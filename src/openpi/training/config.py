...
class LeRobotAirbotDataConfig(DataConfigFactory):
    ...
    def __post_init__(self):
        images = {
            ...
            "cam_tp": "observation.tp_image",
            "cam_ref": "observation.ref_image",
        }
...
class TrainConfig:
    ...
    assets_base_dir: str = "/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/ych/destroy/openpi-airbot/assets"
    # Base directory for checkpoints.
    checkpoint_base_dir: str = "/baai-cwm-nas/algorithm/zongzheng.zhang/ych/destroy/openpi-airbot/checkpoints"
...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi0_pick_bottle_into_box_finetune_new3",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_pick_bottle_into_box_new3",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_pick_bottle_into_box_finetune_new3",
            ),
            default_prompt="Pick up the bottle and put it in the box.",
    ...
    TrainConfig(
        ...
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_pour_water",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_pour_water",
            ),
            #记得去policy改
            default_prompt="Pick up the bottle and pour water into the cup until it is half full.",
    ...
    TrainConfig(
        name="pi0_pick_up_glass_rod",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_pick_up_glass_rod",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_pick_up_glass_rod",
            ),
            #记得去policy改
            default_prompt="PICK_UP_GLASS_ROD",
    ...
    TrainConfig(
        name="pi0_pick_up_glass_rod2",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_pick_up_glass_rod2",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_pick_up_glass_rod2",
            ),
            #记得去policy改
            default_prompt="PICK_UP_GLASS_ROD",
    ...
    TrainConfig(
        name="pi0_pick_up_glass_rod3",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_pick_up_glass_rod3",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_pick_up_glass_rod3",
            ),
            #记得去policy改
            default_prompt="PICK_UP_GLASS_ROD",
    ...
    TrainConfig(
        name="pi0_pick_up_glass_rod3_400_4cam",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_pick_up_glass_rod3_400",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_pick_up_glass_rod3_400_4cam",
            ),
            #记得去policy改
            default_prompt="PICK_UP_GLASS_ROD_3CAM",
    ...
    TrainConfig(
        name="pi0_pick_up_glass_rod3_400_5cam",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_pick_up_glass_rod3_5cam",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_pick_up_glass_rod3_400_5cam",
            ),
            #记得去policy改
            default_prompt="In the image input, the last image serves as the reference image for picking up the glass rod, where the red point is the target point for the robotic arm to grasp.Using the right arm of the robotic arm, carefully grasp the glass rod and lift it gently.",
    ...
    TrainConfig(
        name="pi0_fire_wire_ych3_5cam",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_fire_wire_ych3_5cam",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/cwm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_fire_wire_ych3_5cam",
            ),
            #记得去policy改
            default_prompt="FIRE_WIRE_5CAM",
    ...
    TrainConfig(
        name="pi0_dip_cuso43_5cam",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_dip_cuso43_5cam",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/cwm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_dip_cuso43_5cam",
            ),
            #记得去policy改
            default_prompt="DIP_CUSO4_5CAM",
    ...
    TrainConfig(
        name="pi0_stir_solution_5cam",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_stir_solution_5cam",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/cwm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_stir_solution_5cam",
            ),
            #记得去policy改
            default_prompt="STIR_SOLUTION_5CAM",
        ...
        # weight_loader=weight_loaders.CheckpointWeightLoader("/baai-cwm-nas/algorithm/zongzheng.zhang/ych/destroy/openpi-airbot/checkpoints/pi0_pick_up_glass_rod3_3cam/my_experiment_20250407/50000/params"),
        weight_loader=weight_loaders.CheckpointWeightLoader("s3://openpi-assets/checkpoints/pi0_base/params"),
        num_train_steps=30_000,
        freeze_filter=pi0.Pi0Config(
            paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"
    ...
    TrainConfig(
        name="pi0_press_heater_5cam",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_press_heater_5cam",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/cwm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_press_heater_5cam",
            ),
            #记得去policy改
            default_prompt="PRESS_HEATER_5CAM",
    ...
    TrainConfig(
        name="pi0_dip_cuso4_4cam",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_dip_cuso4",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_dip_cuso4_4cam",
            ),
            #记得去policy改
            default_prompt="DIP_CUSO4",
    ...
    TrainConfig(
        name="pi0_fire_wire_ych_4cam",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_fire_wire_ych",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_fire_wire_ych_4cam",
            ),
            #记得去policy改
            default_prompt="FIRE_WIRE",
    ...
    TrainConfig(
        name="pi0_pick_up_glass_rod4",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_pick_up_glass_rod4",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_pick_up_glass_rod4",
            ),
            #记得去policy改
            default_prompt="PICK_UP_GLASS_ROD",
    ...
    TrainConfig(
        name="pi0_pick_up_glass_rod5",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_pick_up_glass_rod5",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_pick_up_glass_rod5",
            ),
            #记得去policy改
            default_prompt="PICK_UP_GLASS_ROD",
    ...
    TrainConfig(
        name="pi0_pick_bottle_black2",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_pick_bottle_black2",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_pick_bottle_black2",
            ),
            #记得去policy改
            default_prompt="PICK_BOTTLE_BLACK",
    ...
    TrainConfig(
        name="pi0_pick_bottle_black3",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_pick_bottle_black3",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_pick_bottle_black3",
            ),
            #记得去policy改
            default_prompt="PICK_BOTTLE_BLACK",
    ...
    TrainConfig(
        name="pi0_pick_bottle_black4",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_pick_bottle_black4",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_pick_bottle_black4",
            ),
            #记得去policy改
            default_prompt="PICK_BOTTLE_BLACK",
    ...
    TrainConfig(
        name="pi0_plug_dual_port_charger",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_plug_dual_port_charger",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_plug_dual_port_charger",
            ),
            #记得去policy改
            default_prompt="PLUG_DUAL_PROOG_CHARGER",
    ...
    TrainConfig(
        name="pi0_plug_dual_port_charger2",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_plug_dual_port_charger2",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_plug_dual_port_charger2",
            ),
            #记得去policy改
            default_prompt="PLUG_DUAL_PROOG_CHARGER",
    ...
    TrainConfig(
        name="pi0_plug_dual_port_charger2.5",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_plug_dual_port_charger2.5",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_plug_dual_port_charger2.5",
            ),
            #记得去policy改
            default_prompt="PLUG_DUAL_PROOG_CHARGER",
    ...
    TrainConfig(
        name="pi0_fire_test_tube_5cam",
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_fire_test_tube_5cam",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/cwm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_fire_test_tube_5cam",
            ),
            #记得去policy改
            default_prompt="POUR_WATER_INTO_CUP",
    ...
    TrainConfig(
        ...
        model=pi0.Pi0Config(paligemma_variant="gemma_2b_lora", action_expert_variant="gemma_300m_lora"),
        data=LeRobotAirbotDataConfig(
            repo_id="ych_newpick/pi0_plug_usb",
            assets=AssetsConfig(
                assets_dir="/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/.cache/openpi/openpi-assets/checkpoints",
                asset_id="pi0_plug_usb",
            ),
            #记得去policy改
            default_prompt="PLUG_USB",
