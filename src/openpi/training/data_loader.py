...
def transform_dataset(dataset: Dataset, data_config: _config.DataConfig, *, skip_norm_stats: bool = False) -> Dataset:
    ...
    if data_config.repo_id != "fake" and not skip_norm_stats:
        ...
        # norm_stats_path = "/baai-cwm-1/baai_cwm_ml/algorithm/zongzheng.zhang/ych/destroy/openpi-airbot/assets/pi0_pick_bottle_into_box_finetune_new3/ych_newpick/pi0_pick_bottle_into_box_new3"
        # print(f'load norm_stats from {norm_stats_path}')
