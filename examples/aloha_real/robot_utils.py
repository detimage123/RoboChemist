...
class ImageRecorder:
    def __init__(self, init_node=True, is_debug=False):
        ...
        self.camera_names = ["cam_high", "cam_low", "cam_left_wrist", "cam_right_wrist", "cam_tp", "cam_ref"]
        ...
        for cam_name in self.camera_names:
            ...
            elif cam_name == "cam_tp":
                callback_func = self.image_cb_cam_tp
            elif cam_name == "cam_ref":
                callback_func = self.image_cb_cam_ref
            else:
    ...
    def image_cb_cam_tp(self, data):
        cam_name = "cam_tp"
        return self.image_cb(cam_name, data)
    
    def image_cb_cam_ref(self, data):
        cam_name = "cam_ref"
        return self.image_cb(cam_name, data)
